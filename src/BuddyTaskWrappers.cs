...
using System.Threading.Tasks;
    ...
    public static class UserTaskWrappers
    {
        ...
        public static System.Threading.Tasks.Task<IEnumerable<PicturePublic>> GetProfilePhotosAsync(this Buddy.User user)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IEnumerable<PicturePublic>>();
            user.GetProfilePhotosInternal((bcr) =>
            {
    ...
    public static class AuthenticatedUserTaskWrappers
    {
        ...
        public static System.Threading.Tasks.Task<Boolean> DeleteAsync(this Buddy.AuthenticatedUser authenticatedUser)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            authenticatedUser.DeleteInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> UpdateAsync(this Buddy.AuthenticatedUser authenticatedUser, string name = "", string password = "", Buddy.UserGender gender = UserGender.Any, int age = 0, string email = "", Buddy.UserStatus status = UserStatus.Any, bool fuzzLocation = false, bool celebrityMode = false, string appTag = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            authenticatedUser.UpdateInternal(name, password, gender, age, email, status, fuzzLocation, celebrityMode, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<Picture> GetPictureAsync(this Buddy.AuthenticatedUser authenticatedUser, int pictureId)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Picture>();
            authenticatedUser.GetPictureInternal(pictureId, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<IEnumerable<PhotoAlbumPublic>> SearchForAlbumsAsync(this Buddy.AuthenticatedUser authenticatedUser, int searchDistanceInMeters = 99999999, double latitude = 0, double longitude = 0, int limitResults = 50)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IEnumerable<PhotoAlbumPublic>>();
            authenticatedUser.SearchForAlbumsInternal(searchDistanceInMeters, latitude, longitude, limitResults, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> DeleteProfilePhotoAsync(this Buddy.AuthenticatedUser authenticatedUser, Buddy.PicturePublic picture)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            authenticatedUser.DeleteProfilePhotoInternal(picture, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> SetProfilePhotoAsync(this Buddy.AuthenticatedUser authenticatedUser, Buddy.PicturePublic picture)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            authenticatedUser.SetProfilePhotoInternal(picture, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<User> FindUserAsync(this Buddy.AuthenticatedUser authenticatedUser, int id)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<User>();
            authenticatedUser.FindUserInternal(id, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> AddProfilePhotoAsync(this Buddy.AuthenticatedUser authenticatedUser, Stream photoSteam, string appTag = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            authenticatedUser.AddProfilePhotoInternal(photoSteam, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> CheckInAsync(this Buddy.AuthenticatedUser authenticatedUser, double latitude, double longitude, string comment = "", string appTag = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            authenticatedUser.CheckInInternal(latitude, longitude, comment, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<IEnumerable<CheckInLocation>> GetCheckInsAsync(this Buddy.AuthenticatedUser authenticatedUser, System.DateTime afterDate = default(DateTime))
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IEnumerable<CheckInLocation>>();
            authenticatedUser.GetCheckInsInternal(afterDate, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
    ...
    public static class BuddyClientTaskWrappers
    {
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> CheckIfUsernameExistsAsync(this Buddy.BuddyClient buddyClient, string username)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            buddyClient.CheckIfUsernameExistsInternal(username, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<AuthenticatedUser> CreateUserAsync(this Buddy.BuddyClient buddyClient, string name, string password, Buddy.UserGender gender = UserGender.Any, int age = 0, string email = "", Buddy.UserStatus status = UserStatus.Any, bool fuzzLocation = false, bool celebrityMode = false, string appTag = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<AuthenticatedUser>();
            buddyClient.CreateUserInternal(name, password, gender, age, email, status, fuzzLocation, celebrityMode, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns></returns>
        public static System.Threading.Tasks.Task<Int32> StartSessionAsync(this Buddy.BuddyClient buddyClient, Buddy.AuthenticatedUser user, string sessionName, string appTag = null)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Int32>();
            buddyClient.StartSessionInternal(user, sessionName, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <param name="appTag">An optional custom tag to include with the session.</param>
        /// <returns></returns>
        public static System.Threading.Tasks.Task<Boolean> EndSessionAsync(this Buddy.BuddyClient buddyClient, Buddy.AuthenticatedUser user, int sessionId, string appTag = null)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            buddyClient.EndSessionInternal(user, sessionId, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns></returns>
        public static System.Threading.Tasks.Task<Boolean> RecordSessionMetricAsync(this Buddy.BuddyClient buddyClient, Buddy.AuthenticatedUser user, int sessionId, string metricKey, string metricValue, string appTag = null)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            buddyClient.RecordSessionMetricInternal(user, sessionId, metricKey, metricValue, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<String> PingAsync(this Buddy.BuddyClient buddyClient)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<String>();
            buddyClient.PingInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<DateTime> GetServiceTimeAsync(this Buddy.BuddyClient buddyClient)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<DateTime>();
            buddyClient.GetServiceTimeInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// </summary>
        /// <returns>A Task&lt;String&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<String> GetServiceVersionAsync(this Buddy.BuddyClient buddyClient)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<String>();
            buddyClient.GetServiceVersionInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<IEnumerable<String>> GetUserEmailsAsync(this Buddy.BuddyClient buddyClient, int fromRow, int pageSize = 10)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IEnumerable<String>>();
            buddyClient.GetUserEmailsInternal(fromRow, pageSize, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <param name="pageSize">Used for paginig, specify page size.</param>
        /// <returns>A Task&lt;IEnumerable&lt;User&gt; &gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<IEnumerable<User>> GetUserProfilesAsync(this Buddy.BuddyClient buddyClient, int fromRow, int pageSize = 10)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IEnumerable<User>>();
            buddyClient.GetUserProfilesInternal(fromRow, pageSize, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<IEnumerable<ApplicationStatistics>> GetApplicationStatisticsAsync(this Buddy.BuddyClient buddyClient)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IEnumerable<ApplicationStatistics>>();
            buddyClient.GetApplicationStatisticsInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;AuthenticatedUser&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<AuthenticatedUser> LoginAsync(this Buddy.BuddyClient buddyClient, string token)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<AuthenticatedUser>();
            buddyClient.LoginInternal(token, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;AuthenticatedUser&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<AuthenticatedUser> LoginAsync(this Buddy.BuddyClient buddyClient, string username, string password)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<AuthenticatedUser>();
            buddyClient.LoginInternal(username, password, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> CheckIfEmailExistsAsync(this Buddy.BuddyClient buddyClient, string email)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            buddyClient.CheckIfEmailExistsInternal(email, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
    ...
    public static class DeviceTaskWrappers
    {
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> RecordInformationAsync(this Buddy.Device device, string osVersion, string deviceType, Buddy.AuthenticatedUser user, string appVersion = "1.0", double latitude = 0, double longitude = 0, string metadata = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            device.RecordInformationInternal(osVersion, deviceType, user, appVersion, latitude, longitude, metadata, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <param name="metadata">An optional application specific metadata string to include with the report.</param>
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> RecordCrashAsync(this Buddy.Device device, string methodName, string osVersion, string deviceType, Buddy.AuthenticatedUser user, string stackTrace = "", string appVersion = "1.0", double latitude = 0, double longitude = 0, string metadata = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            device.RecordCrashInternal(methodName, osVersion, deviceType, user, stackTrace, appVersion, latitude, longitude, metadata, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
    ...
    public static class NotificationsTaskWrappers
    {
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> RegisterDeviceAsync(this Buddy.Notifications notifications, string deviceUri, bool enableTile = true, bool enableRaw = true, bool enableToast = true, string groupName = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            notifications.RegisterDeviceInternal(deviceUri, enableTile, enableRaw, enableToast, groupName, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// </summary>
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> UnregisterDeviceAsync(this Buddy.Notifications notifications)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            notifications.UnregisterDeviceInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<IEnumerable<RegisteredDevice>> GetRegisteredDevicesAsync(this Buddy.Notifications notifications, string forGroup = "", int pageSize = 10, int currentPage = 1)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IEnumerable<RegisteredDevice>>();
            notifications.GetRegisteredDevicesInternal(forGroup, pageSize, currentPage, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<IDictionary<String, Int32>> GetGroupsAsync(this Buddy.Notifications notifications)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IDictionary<String, Int32>>();
            notifications.GetGroupsInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> SendTileAsync(this Buddy.Notifications notifications, string imageUri, int senderUserId, int messageCount = -1, string messageTitle = "", System.DateTime deliverAfter = default(DateTime), string groupName = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            notifications.SendTileInternal(imageUri, senderUserId, messageCount, messageTitle, deliverAfter, groupName, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <param name="groupName">Send messages to an entire group of users, not just a one.</param>
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> SendRawMessageAsync(this Buddy.Notifications notifications, string rawMessage, int senderUserId, System.DateTime deliverAfter = default(DateTime), string groupName = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            notifications.SendRawMessageInternal(rawMessage, senderUserId, deliverAfter, groupName, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <param name="groupName">Send messages to an entire group of users, not just a one.</param>
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> SendToastMessageAsync(this Buddy.Notifications notifications, string toastTitle, string toastSubtitle, int senderUserId, string toastParameter = "", System.DateTime deliverAfter = default(DateTime), string groupName = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            notifications.SendToastMessageInternal(toastTitle, toastSubtitle, senderUserId, toastParameter, deliverAfter, groupName, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
    ...
    public static class PhotoAlbumTaskWrappers
    {
        ...
        /// </summary>
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> DeleteAsync(this Buddy.PhotoAlbum photoAlbum)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            photoAlbum.DeleteInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Picture&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Picture> AddPictureAsync(this Buddy.PhotoAlbum photoAlbum, Stream photoStream, string comment = "", double latitude = 0, double longitude = 0, string appTag = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Picture>();
            photoAlbum.AddPictureInternal(photoStream, comment, latitude, longitude, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Picture&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Picture> AddPictureWithWatermarkAsync(this Buddy.PhotoAlbum photoAlbum, Stream photoStream, string comment = "", double latitude = 0, double longitude = 0, string appTag = "", string watermarkmessage = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Picture>();
            photoAlbum.AddPictureWithWatermarkInternal(photoStream, comment, latitude, longitude, appTag, watermarkmessage, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
    ...
    public static class PhotoAlbumsTaskWrappers
    {
        ...
        public static System.Threading.Tasks.Task<PhotoAlbum> CreateAsync(this Buddy.PhotoAlbums photoAlbums, string name, bool isPublic = false, string appTag = "")
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<PhotoAlbum>();
            photoAlbums.CreateInternal(name, isPublic, appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;PhotoAlbum&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<PhotoAlbum> GetAsync(this Buddy.PhotoAlbums photoAlbums, int albumId)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<PhotoAlbum>();
            photoAlbums.GetInternal(albumId, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;PhotoAlbum&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<PhotoAlbum> GetAsync(this Buddy.PhotoAlbums photoAlbums, string albumName)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<PhotoAlbum>();
            photoAlbums.GetInternal(albumName, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<IEnumerable<PhotoAlbum>> GetAllAsync(this Buddy.PhotoAlbums photoAlbums, System.DateTime afterDate = default(DateTime))
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IEnumerable<PhotoAlbum>>();
            photoAlbums.GetAllInternal(afterDate, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
    ...
    public static class PictureTaskWrappers
    {
        ...
        /// </summary>
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> DeleteAsync(this Buddy.Picture picture)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            picture.DeleteInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        public static System.Threading.Tasks.Task<IDictionary<String, String>> SupportedFiltersAsync(this Buddy.Picture picture)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<IDictionary<String, String>>();
            picture.SupportedFiltersInternal((bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
        ...
        /// <returns>A Task&lt;Boolean&gt;that can be used to monitor progress on this call.</returns>
        public static System.Threading.Tasks.Task<Boolean> SetAppTagAsync(this Buddy.Picture picture, string appTag)
        {
            var tcs = new System.Threading.Tasks.TaskCompletionSource<Boolean>();
            picture.SetAppTagInternal(appTag, (bcr) =>
            {
                if (bcr.Error != BuddyServiceClient.BuddyError.None)
                {
                    tcs.TrySetException(new BuddyServiceException(bcr.Error));
